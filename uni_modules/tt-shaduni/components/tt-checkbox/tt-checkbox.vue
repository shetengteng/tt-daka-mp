...
<style>
.tt-checkbox { display: inline-flex; align-items: center; gap: 16rpx; cursor: pointer; height: 44rpx; line-height: 44rpx; -webkit-tap-highlight-color: transparent; user-select: none; }
...
/* 确保插槽内容高度稳定 */
.tt-checkbox > slot { line-height: 44rpx; }
</style>
