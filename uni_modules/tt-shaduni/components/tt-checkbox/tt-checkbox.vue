...
<style>
.tt-checkbox { display: inline-flex; align-items: center; gap: 16rpx; cursor: pointer; height: 44rpx; line-height: 44rpx; -webkit-tap-highlight-color: transparent; user-select: none; vertical-align: middle; }
.tt-checkbox--disabled { opacity: 0.5; cursor: not-allowed; }
.tt-checkbox__box { width: 36rpx; height: 36rpx; border: 1.10rpx solid var(--tt-border, #e5e5e5); border-radius: 8rpx; display: flex; align-items: center; justify-content: center; transition: all 0.15s; flex-shrink: 0; margin-top: 0 !important; }
.tt-checkbox--checked .tt-checkbox__box { background: var(--tt-primary, #171717); border-color: var(--tt-primary, #171717); }
.tt-checkbox__label { font-size: 28rpx; color: var(--tt-foreground, #0a0a0a); line-height: 44rpx; }
</style>
